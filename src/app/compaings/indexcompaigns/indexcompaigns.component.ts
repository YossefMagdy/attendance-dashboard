...
@Component({
  selector: 'app-indexcompaigns',
  templateUrl: './indexcompaigns.component.html',
  styleUrls: ['./indexcompaigns.component.scss']
})
export class IndexcompaignsComponent {
  data: any[] = [];
  heads =['#','اسم الحملة', 'عدد التقييمات', 'الحالة', 'تاريخ نهاية الحملة ', 'تاريخ نهاية الحملة',  'Actions']
  ;
types = [{"id":"1","name":"running"},{"id":"2","name":"pending"},{"id":"3","name":"stopped"}]
  loading?: boolean; 

  constructor(
    private service: CampaingsService,
